...
export const TOOL_METADATA: Record<string, ToolMetadata> = {
  ...
  create_chat_view_comment: {
    ...
    efficiency_hint:
      'Most direct way to post to chat channels. Use find_chat_channels if you need to discover chat view IDs first.',
  ...
  get_chat_view_comments: {
    ...
    efficiency_hint:
      'Direct way to read chat messages. More efficient than navigating workspace hierarchy.',
    prerequisites: ['chat_view_id'],
  ...
  get_workspaces: {
    ...
    alternatives: [],
    efficiency_hint:
      'Use only when you need to discover workspaces. Avoid if you already know workspace structure.',
  ...
  get_spaces: {
    ...
    efficiency_hint:
      'Use when you need to explore workspace structure. Consider search tools for specific items.',
  ...
  get_views: {
    ...
    efficiency_hint:
      'Use with type filter for efficiency. Consider find_chat_channels for chat discovery.',
  ...
  search_docs: {
    ...
    efficiency_hint:
      'Most efficient way to find specific documents. Prefer over workspace navigation.',
  ...
  get_tasks: {
    ...
    efficiency_hint:
      'Use when you need all tasks from a list. Consider get_view_tasks for filtered results.',
  ...
  if (
    ...
    if (
      ...
      return {
        ...
        workflow_hint:
          'If you have chat_view_id → create_chat_view_comment. If not → find_chat_channels → create_chat_view_comment'
      };
    }
    ...
    if (
      ...
      return {
        ...
        workflow_hint:
          'If you have chat_view_id → get_chat_view_comments. If not → find_chat_channels → get_chat_view_comments'
      };
    }
  }
...
export function getEfficiencyRating(tools: string[]): {
  ...
  const hierarchicalTools = tools.filter(
    tool => TOOL_METADATA[tool]?.efficiency === 'hierarchical'
  ).length;
