...
export function setupWebhookTools(server: McpServer): void {
  ...
  server.tool(
    ...
    {
      workspace_id: idSchema().describe('The ID of the workspace to create the webhook in'),
      endpoint: z
        .string()
        .url()
  ...
  server.tool(
    ...
    {
      workspace_id: idSchema().describe('The ID of the workspace to get webhooks from'),
      status: z
  ...
  server.tool(
    ...
    {
      workspace_id: idSchema().describe('The ID of the workspace the webhook belongs to'),
      webhook_id: idSchema().describe('The ID of the webhook to get'),
    },
    async args => {
      try {
  ...
  server.tool(
    ...
    {
      webhook_id: idSchema().describe('The ID of the webhook to delete'),
    },
    async args => {
      try {
