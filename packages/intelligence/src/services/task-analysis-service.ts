...
export class TaskAnalysisService {
  private readonly complexityKeywords = {
    technical: ['algorithm', 'architecture', 'performance', 'scalability', 'security', 'integration', 'api', 'database', 'framework'],
    business: ['workflow', 'process', 'stakeholder', 'requirement', 'compliance', 'regulation', 'policy', 'approval'],
    integration: ['external', 'third-party', 'service', 'dependency', 'sync', 'migration', 'import', 'export'],
    uncertainty: ['unclear', 'unknown', 'investigate', 'research', 'explore', 'might', 'possibly', 'potentially'],
  };
